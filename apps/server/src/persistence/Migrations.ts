...
import Migration0016 from "./Migrations/016_ProjectionThreadProposedPlanImplementationCompatibility.ts";
...
const loader = Migrator.fromRecord({
  ...
  "16_ProjectionThreadProposedPlanImplementationCompatibility": Migration0016,
});
